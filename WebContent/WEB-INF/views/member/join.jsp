...
if(member_name.length < 2 || member_name.length > 10) {
  ...
  c.innerHTML=null;
  var a= document.createElement("span"); //오류 텍스트
          ...
          <div class="form-group">
           ...
           <div class="form-group">
              ...
              <div class="col-md-6" style="margin-left: 14.8%; margin-top: 0.3%"  >
                ...
                <span id=member_namecheck class="error" oninput="nameCheck()"></span>
              </div>
           </div>
           ...
           <div class="form-group">
              ...
              <div class="col-md-6" style="margin-left: 14.8%; margin-top: 0.3%"  >
                ...
                <span id="member_socialcheck" class="error" oninput="socialCheck()"></span>
              </div>
           </div>
           ...
           <div class="form-group">
              ...
              <div class="col-md-6">
                ...
                <div class="col-md-6" style="margin-left: 14.8%; margin-top: 0.3%"  >
                <span id="member_nicknamecheck" class="error" oninput="nicknameCheck()"></span>
           ...
           <div class="form-group">
              ...
              <div class="col-md-6" style="margin-left: 14.8%; margin-top: 0.3%"  >
                ...
                <span id="member_telcheck" class="error" oninput="telCheck()"></span>
              </div>
           </div>
