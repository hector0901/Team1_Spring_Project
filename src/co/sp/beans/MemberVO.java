...
//  COMMENT ON COLUMN member.member_nickname is 'È¸¿ø ´Ğ³×ÀÓ';
//  COMMENT ON COLUMN member.member_tel is 'È¸¿ø ¿¬¶ôÃ³';
//  COMMENT ON COLUMN member.member_email is 'È¸¿ø ÀÌ¸ŞÀÏ';
...
//  COMMENT ON COLUMN member.member_size is 'È¸¿ø ÇÁ·ÎÇÊ ÀÌ¹ÌÁö Å©±â';
  ...
  // ·Î±×ÀÎÀÌ µÇ¾îÀÖÁö ¾ÊÀº ÃÊ±â°ª + ¾ÆÀÌµğ Áßº¹ X
  public MemberVO() {
    this.idExist = false;
